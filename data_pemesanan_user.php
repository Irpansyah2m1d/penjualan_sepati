...
$data_pemesanan = getData("SELECT * FROM tbl_pemesanan JOIN tbl_user ON tbl_pemesanan.id_user = tbl_user.id_user WHERE tbl_pemesanan.id_user = '$id_user' ");
